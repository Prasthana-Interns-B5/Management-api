...
RSpec.describe "Feedbacks", type: :request do
  let!(:employee1) {create:employee, name:"employee",email:"employee@gmail.com",role:"ur_hr",password:'123456'}
  ...
  describe "POST /create" do
    let(:valid_params) {{feedback:{feedback_type:"company feedback",employee_feedback:"this is employee feedback"}}}
