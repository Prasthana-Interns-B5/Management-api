...
RSpec.describe "Employees", type: :request do
  ...
  describe "POST /employees" do
    let(:valid_params) { { employee: { name: 'subordinate-1', role: 'subordinate',email:'subordinate-1@gmail.com',password:'123456' } } }
  ...
  describe "GET /employees/:id" do
    let(:employee4) {create:employee,name:'john11',role:'subordinate',email:'john11@gmail.com',password:'123456' }
  ...
  describe "PATCH /employees/:id" do
    ...
    describe "Delete /employees/:id" do
       let(:employee4) {create:employee,name:'john1',role:'subordinate',email:'john1@gmail.com',password:'123456' }
